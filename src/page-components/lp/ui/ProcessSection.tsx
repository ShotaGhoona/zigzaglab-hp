...
export default function ProcessSection() {
  ...
  const processSteps = [
    ...
    },
    {
      step: "02", 
      title: "校正データの作成",
      description: "お客様からいただいたデザインデータを確認し、グッズ製作に合わせて色味やサイズの調整をいたします。",
      duration: "1〜3営業日"
    },
    {
      step: "03",
      title: "サンプル作成・校了決定",
      description: "校正データにてサンプルを作成し、色味や品質をご確認いただきます。",
      duration: "3〜5営業日"
    },
    {
      step: "04",
      title: "本格生産",
      description: "サンプルの確認後、機構部品メーカーの技術力を活かした高品質な製品を生産いたします。",
      duration: "5〜10営業日"
    },
    {
      step: "05",
